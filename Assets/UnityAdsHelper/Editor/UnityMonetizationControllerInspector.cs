...
//         {
//             _unityAdsHelper = _unityAdsHelper ? _unityAdsHelper : (UnityAdsHelper) target;
//         }
//
...
//             
//             _unityAdsHelper.unityAdsSettings = EditorGUILayout.ObjectField("Unity Ads Settings", 
//                 _unityAdsHelper.unityAdsSettings, typeof(UnityAdsSettings), false) as UnityAdsSettings;
//             if (_unityAdsHelper.unityAdsSettings == null)
//             {
...
//                                 _unityAdsHelper.unityAdsSettings,
...
//                         {
//                             _unityAdsHelper.unityAdsSettings = (UnityAdsSettings) EditorGUIUtility.GetObjectPickerObject();
...
//                     {
//                         Selection.SetActiveObjectWithContext(_unityAdsHelper.unityAdsSettings,
//                             _unityAdsHelper);
//                     }
//                 }
//             }
//
//             _unityAdsHelper.unityAdsListener = EditorGUILayout.ObjectField("Unity Ads Listener",
//                 _unityAdsHelper.unityAdsListener, typeof(UnityAdsListener), false) as UnityAdsListener;
//             if (_unityAdsHelper.unityAdsListener == null)
//             {
...
//                                 _unityAdsHelper.unityAdsListener,
...
//                             EditorGUIUtility.GetObjectPickerControlID() == _currentPickerControlId)
//                         {
//                             _unityAdsHelper.unityAdsListener = (UnityAdsListener) EditorGUIUtility.GetObjectPickerObject();
// //                            EditorUtility.SetDirty(_unityMonetizationController);
//                         }
//                     }
//                     EditorGUILayout.EndHorizontal();
...
//                     {
//                         Selection.SetActiveObjectWithContext(_unityAdsHelper.unityAdsListener,
//                             _unityAdsHelper);
//                     }
//                 }
//             }
